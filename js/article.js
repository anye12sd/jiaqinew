...
function selectToUrl(){
    ...
    window.location.href = "./article.html?page=" + selectedPage;
}

function toIndex(){
    window.location.href ="./article.html?page=1";
}

function toPreviout(){
    currentPage = currentPage == 1 ? 1 : --currentPage;
    location.href = "./article.html?page=" + currentPage;
}
...
function toLast(){
    location.href = "./article.html?page=" + allPage;
}
...
function createHtml(result){
    ...
    var h3Html = "";
    h3Html = ' » <a href="./article.html">技术文章</a> » <a href="#">'+aSearch[0].title+'</a>';
