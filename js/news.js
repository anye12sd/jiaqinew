...
function selectToUrl(){
    ...
    window.location.href = "./news.html?page=" + selectedPage;
}

function toIndex(){
    window.location.href ="./new.html?page=1";
}

function toPreviout(){
    currentPage = currentPage == 1 ? 1 : --currentPage;
    location.href = "./news.html?page=" + currentPage;
}
...
function toLast(){
    location.href = "./news.html?page=" + allPage;
}
...
function createHtml(result){
    ...
    var h3Html = "";
    h3Html = ' » <a href="./news.html">技术文章</a> » <a href="#">'+aSearch[0].title+'</a>';
